...
public final class JSONLoginConfigurer<H extends HttpSecurityBuilder<H>> extends
    AbstractAuthenticationFilterConfigurer<H, JSONLoginConfigurer<H>, UsernamePasswordJSONAuthenticationFilter>
{
   ...
   */
  @Autowired
  public JSONLoginConfigurer(UsernamePasswordJSONAuthenticationFilter filter) {
    super(filter, null);
   ...
   *
   * <pre>
   * <!-- loginProcessingUrl should correspond to JSONLoginConfigurer#loginProcessingUrl. Don't forget to perform a POST -->
   * &lt;c:url value="/login" var="loginProcessingUrl"/&gt;
   * &lt;form action="${loginProcessingUrl}" method="post"&gt;
   *    &lt;fieldset&gt;
   *        &lt;legend&gt;Please Login&lt;/legend&gt;
   *        &lt;!-- use param.error assuming JSONLoginConfigurer#failureUrl contains the query parameter error --&gt;
   ...
   * @return he {@link JSONLoginConfigurer} for additional customization
   */
